...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header scrollToProducts={() => productSectionRef.current?.scrollIntoView({ behavior: 'smooth' })} />

      <section className="w-full bg-gradient-to-r from-purple-50 to-pink-50 pb-4 relative z-0">
    ...
    <div className="flex items-center gap-1">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 py-6 md:py-0 md:h-[420px] flex flex-col md:flex-row items-center">
          ...
          {/* LEFT SIDE */}
          <div className="w-full md:w-1/3 flex justify-center md:justify-start items-center md:items-end md:pl-16 md:pb-16 mb-4 md:mb-0">          </div>
